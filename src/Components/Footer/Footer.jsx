...
function Footer() {
  return (
    ...
    <footer className="w-full border-2 pt-3">
      ...
      <div className="mx-auto max-w-6xl items-center justify-between px-4 md:flex lg:px-0">
        <div className="inline-flex items-center">
          ...
          <span className="ml-4 text-lg font-bold">PostMart</span>
        </div>
        <div className="mt-4 md:mt-0">
          <p className="text-sm font-medium text-gray-500">© 2023 PostMart. All rights reserved.</p>
        </div>
      </div>
    </footer>
